...
public class TWGP_Balance extends SequentialCommandGroup {

  public TWGP_Balance(Swerve s_Swerve, Brazo b_Brazo, Gripper g_Gripper) {

    final List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup(
    "2GP&Balance", 
    new PathConstraints(2, 1),
    new PathConstraints(5, 1), 
    ...
    new PIDConstants(0.5, 0.45, 0.0), // PID constants to correct for translation error (used to create the X and Y PID controllers)
    new PIDConstants(0.5, 1.1, 0.0), // PID constants to correct for rotation error (used to create the rotation controller)
