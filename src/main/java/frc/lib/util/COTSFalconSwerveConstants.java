...
public class COTSFalconSwerveConstants {
    ...
    /** Swerve WestCoast Swerve X inverted*/ 
    public static COTSFalconSwerveConstants SWRVX(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4); //Hay que poner el diametro de la llanta

        /**/
        double angleGearRatio = (10.3/1.0); //Hay que poner la reducción del ángulo

        double angleKP = 0.2; //Hay que tunear estos valores
        double angleKI = 0.0;
        double angleKD = 0.0;
        double angleKF = 0.0;

        boolean driveMotorInvert = false;//Verificar si se tienen que cambiar
        boolean angleMotorInvert = true;
        boolean canCoderInvert = false;
        return new COTSFalconSwerveConstants(wheelDiameter, angleGearRatio, driveGearRatio, angleKP, angleKI, angleKD, angleKF, driveMotorInvert, angleMotorInvert, canCoderInvert);
    }
    ...
    public class driveGearRatios{
        ...
        //SWRVX//
        public static final double SWRVX = (6.55/1.0);//Hay que poner la reducción del Drive
    }
}
